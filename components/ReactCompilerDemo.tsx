...
export function ReactCompilerDemo() {
  ...
  const isReactCompilerEnabled = config?.expo?.experiments?.reactCompiler;
    ...
    <>
      ...
      >
        <ThemedText style={{ marginBottom: theme.space8 }}>
          Toggle the value of this Switch. React compiler is currently{" "}
          <ThemedText fontWeight="bold">
            {isReactCompilerEnabled ? "Enabled" : "Disabled"}
          </ThemedText>{" "}
